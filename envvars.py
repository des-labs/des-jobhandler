...
ORACLE_USER_MANAGER_HOST_PUBLIC = os.environ['ORACLE_USER_MANAGER_HOST_PUBLIC']
ORACLE_USER_MANAGER_HOST_PRIVATE = os.environ['ORACLE_USER_MANAGER_HOST_PRIVATE']
